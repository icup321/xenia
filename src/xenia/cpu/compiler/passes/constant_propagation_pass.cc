...
// Reverted the whole file back to the version before 0e11111(20160114),
// which broke a lot of games's camera and vertices.
// TODO: find out what exactly cause the error and what still can be used.
